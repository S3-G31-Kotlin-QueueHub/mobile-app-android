package com.queue_hub.isis3510_s3_g31.data.queues.remote
...
class FirebaseQueueData(
    private val db: FirebaseFirestore
) : QueueDataService {


    override suspend fun getQueue(idPlace: String): Flow<Queue> = callbackFlow {
    ...
    override suspend fun getPreviousUserQueues(idUser: String): Flow<List<PreviousQueue>> = callbackFlow {
